...
import com.test.model.impl.AdvItemModelImpl;
...
public class AdvItemPersistenceImpl extends BasePersistenceImpl<AdvItem>
	...
	public static final FinderPath FINDER_PATH_FIND_BY_G_T_S = new FinderPath(AdvItemModelImpl.ENTITY_CACHE_ENABLED,
			AdvItemModelImpl.FINDER_CACHE_ENABLED, FINDER_CLASS_NAME_LIST,
			"findByG_T_S",
			new String[] {
				Long.class.getName(), Long.class.getName(),
	 ...
	 * @return the adv item that was removed
	 * @throws com.test.NoSuchAdvItemException if a adv item with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	...
	public AdvItem updateImpl(com.test.model.AdvItem advItem, boolean merge)
	...
	/**
	 * Finds the adv item with the primary key or throws a {@link com.test.NoSuchAdvItemException} if it could not be found.
	 *
	 ...
	 * @throws com.test.NoSuchAdvItemException if a matching adv item could not be found
	 * @throws SystemException if a system exception occurred
	 */
	...
	/**
	 * Finds all the adv items where groupId = &#63; and typeId = &#63; and status = &#63;.
	 *
	 * @param groupId the group id to search with
	 * @param typeId the type id to search with
	 * @param status the status to search with
	...
	/**
	 * Finds a range of all the adv items where groupId = &#63; and typeId = &#63; and status = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	...
	/**
	 * Finds an ordered range of all the adv items where groupId = &#63; and typeId = &#63; and status = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	...
	public List<AdvItem> findByG_T_S(long groupId, long typeId, boolean status,
		...
		List<AdvItem> list = (List<AdvItem>)FinderCacheUtil.getResult(FINDER_PATH_FIND_BY_G_T_S,
				finderArgs, this);
		...
		if (list == null) {
			...
			try {
				...
				if (list == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_FIND_BY_G_T_S,
						finderArgs);
				}
				else {
					cacheResult(list);

					FinderCacheUtil.putResult(FINDER_PATH_FIND_BY_G_T_S,
						finderArgs, list);
				}
	...
	/**
	 * Finds the first adv item in the ordered set where groupId = &#63; and typeId = &#63; and status = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	...
	/**
	 * Finds the last adv item in the ordered set where groupId = &#63; and typeId = &#63; and status = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	...
	/**
	 * Finds the adv items before and after the current adv item in the ordered set where groupId = &#63; and typeId = &#63; and status = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	...
	public AdvItem[] findByG_T_S_PrevAndNext(long itemId, long groupId,
		long typeId, boolean status, OrderByComparator orderByComparator)
		throws NoSuchAdvItemException, SystemException {
		AdvItem advItem = findByPrimaryKey(itemId);
	...
	/**
	 * Counts all the adv items where groupId = &#63; and typeId = &#63; and status = &#63;.
	 *
	 * @param groupId the group id to search with
	 * @param typeId the type id to search with
	 * @param status the status to search with
	...
	public int countByG_T_S(long groupId, long typeId, boolean status)
		...
		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_COUNT_BY_G_T_S,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_G_T_S,
					finderArgs, count);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.test.model.AdvItem")));
