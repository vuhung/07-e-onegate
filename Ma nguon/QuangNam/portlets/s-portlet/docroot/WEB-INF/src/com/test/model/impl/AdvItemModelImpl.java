...
import com.test.model.AdvItemModel;
import com.test.model.AdvItemSoap;
...
/**
 * The base model implementation for the AdvItem service. Represents a row in the &quot;s_AdvItem&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link com.test.model.AdvItemModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link AdvItemImpl}.
 * </p>
 *
 * <p>
 * Never modify or reference this class directly. All methods that expect a adv item model instance should use the {@link com.test.model.AdvItem} interface instead.
 * </p>
 *
 * @author Long
 * @see AdvItemImpl
 * @see com.test.model.AdvItem
 * @see com.test.model.AdvItemModel
 * @generated
 */
public class AdvItemModelImpl extends BaseModelImpl<AdvItem>
	implements AdvItemModel {
	public static final String TABLE_NAME = "s_AdvItem";
	...
	public static final String TABLE_SQL_CREATE = "create table s_AdvItem (itemId LONG not null primary key,createDate DATE null,modifiedDate DATE null,expriedDate DATE null,groupId LONG,companyId LONG,name VARCHAR(75) null,description VARCHAR(75) null,url VARCHAR(75) null,isTargetBlank BOOLEAN,txtMouseOver VARCHAR(75) null,folderId LONG,status BOOLEAN,typeId LONG)";
	public static final String TABLE_SQL_DROP = "drop table s_AdvItem";
	public static final String ORDER_BY_JPQL = " ORDER BY advItem.createDate DESC";
	public static final String ORDER_BY_SQL = " ORDER BY s_AdvItem.createDate DESC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.com.test.model.AdvItem"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.com.test.model.AdvItem"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.com.test.model.AdvItem"));
	...
	public String toXmlString() {
		...
		sb.append("com.test.model.AdvItem");
