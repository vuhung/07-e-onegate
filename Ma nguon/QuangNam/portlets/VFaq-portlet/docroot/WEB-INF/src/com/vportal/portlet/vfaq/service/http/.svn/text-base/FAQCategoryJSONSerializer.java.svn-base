 ...
 * @generated
 */
public class FAQCategoryJSONSerializer {
	public static JSONObject toJSONObject(FAQCategory model) {
		...
		jsonObj.put("catorder", model.getCatorder());
		jsonObj.put("catlevel", model.getCatlevel());
	...
	public static JSONArray toJSONArray(
		com.vportal.portlet.vfaq.model.FAQCategory[] models) {
	...
	public static JSONArray toJSONArray(
		List<com.vportal.portlet.vfaq.model.FAQCategory> models) {
		JSONArray jsonArray = JSONFactoryUtil.createJSONArray();
