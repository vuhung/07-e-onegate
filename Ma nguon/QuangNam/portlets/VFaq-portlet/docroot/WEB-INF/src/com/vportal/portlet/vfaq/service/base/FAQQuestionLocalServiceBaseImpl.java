...
public abstract class FAQQuestionLocalServiceBaseImpl
	implements FAQQuestionLocalService {
	/**
	...
	public FAQQuestion addFAQQuestion(FAQQuestion faqQuestion)
		...
		return faqQuestionPersistence.update(faqQuestion, false);
	}
	...
	public void deleteFAQQuestion(long id)
		...
		faqQuestionPersistence.remove(id);
	}
	...
	public FAQQuestion updateFAQQuestion(FAQQuestion faqQuestion)
		...
		return faqQuestionPersistence.update(faqQuestion, true);
	}
	...
	public FAQQuestion updateFAQQuestion(FAQQuestion faqQuestion, boolean merge)
		...
		return faqQuestionPersistence.update(faqQuestion, merge);
	}
