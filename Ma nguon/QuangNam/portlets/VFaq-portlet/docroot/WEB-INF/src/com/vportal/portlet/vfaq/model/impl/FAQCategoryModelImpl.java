...
import com.vportal.portlet.vfaq.model.FAQCategorySoap;
...
/**
 * The base model implementation for the FAQCategory service. Represents a row in the &quot;vfaq_FAQCategory&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class FAQCategoryModelImpl extends BaseModelImpl<FAQCategory>
	...
	public static final String TABLE_NAME = "vfaq_FAQCategory";
	public static final Object[][] TABLE_COLUMNS = {
			...
			{ "catorder", new Integer(Types.INTEGER) },
			{ "catlevel", new Integer(Types.INTEGER) },
	...
	public static final String TABLE_SQL_CREATE = "create table vfaq_FAQCategory (id_ LONG not null primary key,name VARCHAR(1000) null,description VARCHAR(2000) null,language VARCHAR(75) null,parent LONG,catorder INTEGER,catlevel INTEGER,image VARCHAR(200) null,createdByUser VARCHAR(200) null,createdDate DATE null,modifiedByUser VARCHAR(200) null,modifiedDate DATE null,groupId LONG,userId LONG)";
	public static final String TABLE_SQL_DROP = "drop table vfaq_FAQCategory";
	public static final String ORDER_BY_JPQL = " ORDER BY faqCategory.createdDate DESC";
	public static final String ORDER_BY_SQL = " ORDER BY vfaq_FAQCategory.createdDate DESC";
	 ...
	 */
	public static FAQCategory toModel(FAQCategorySoap soapModel) {
		FAQCategory model = new FAQCategoryImpl();
		...
		model.setCatlevel(soapModel.getCatlevel());
	 ...
	 */
	public static List<FAQCategory> toModels(FAQCategorySoap[] soapModels) {
		List<FAQCategory> models = new ArrayList<FAQCategory>(soapModels.length);

		for (FAQCategorySoap soapModel : soapModels) {
	...
	public Object clone() {
		...
		FAQCategoryModelImpl faqCategoryModelImpl = faqCategoryImpl;
