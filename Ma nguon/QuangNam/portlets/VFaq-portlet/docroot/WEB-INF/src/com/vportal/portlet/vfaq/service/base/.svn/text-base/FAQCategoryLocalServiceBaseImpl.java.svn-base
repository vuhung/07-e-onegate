...
/**
 * The base implementation of the f a q category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.vportal.portlet.vfaq.service.impl.FAQCategoryLocalServiceImpl}.
 * </p>
 *
 * <p>
 * Never modify or reference this class directly. Always use {@link com.vportal.portlet.vfaq.service.FAQCategoryLocalServiceUtil} to access the f a q category local service.
 * </p>
 *
 * @author HOAN
...
public abstract class FAQCategoryLocalServiceBaseImpl
	...
	public FAQCategory addFAQCategory(FAQCategory faqCategory)
		...
		return faqCategoryPersistence.update(faqCategory, false);
	}
	...
	public FAQCategory createFAQCategory(long id) {
		return faqCategoryPersistence.create(id);
	}
	...
	public void deleteFAQCategory(long id)
		...
		faqCategoryPersistence.remove(id);
	}
	...
	public void deleteFAQCategory(FAQCategory faqCategory)
		throws SystemException {
		faqCategoryPersistence.remove(faqCategory);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return faqCategoryPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public FAQCategory getFAQCategory(long id)
		throws PortalException, SystemException {
		return faqCategoryPersistence.findByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getFAQCategoriesCount() throws SystemException {
	...
	public FAQCategory updateFAQCategory(FAQCategory faqCategory)
		...
		return faqCategoryPersistence.update(faqCategory, true);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public FAQCategory updateFAQCategory(FAQCategory faqCategory, boolean merge)
		throws SystemException {
		faqCategory.setNew(false);

		return faqCategoryPersistence.update(faqCategory, merge);
	}
