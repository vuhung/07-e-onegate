...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 <tr>
	<td class="bg_title_news2"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
		<tr>
		  <td width="45">&nbsp;</td>
		  <td width="120" class="title_news" nowrap="nowrap"><%= category.getName() %></td>
		  <td>&nbsp;</td>
		</tr>
	</table></td>
  </tr>
