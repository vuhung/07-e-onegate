<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	%>
		...
		<div class="bg_news_top_tab_on_blue" ><a href="<%=catURL.toString()%>" style="padding-left:15px;padding-right:15px;"><%= category.getName() %></a></div>
	   ...
	   <table width="100%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr>
			<td valign="top">
	          ...
	          <tr>
			    <td colspan="2">
				  <div class="title_new3" style="padding-left:15px;padding-right:15px;"><a href="<%= articleURL %>">&nbsp;» &nbsp;<%= article.getTitle() %></a></div>
				</td>
				 <tr>
			        <td height="5">
			        </td>
