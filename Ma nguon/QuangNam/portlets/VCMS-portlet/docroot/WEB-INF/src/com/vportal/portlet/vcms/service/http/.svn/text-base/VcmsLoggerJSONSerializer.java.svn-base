 ...
 * @generated
 */
public class VcmsLoggerJSONSerializer {
	public static JSONObject toJSONObject(VcmsLogger model) {
	...
	public static JSONArray toJSONArray(
		com.vportal.portlet.vcms.model.VcmsLogger[] models) {
	...
	public static JSONArray toJSONArray(
		List<com.vportal.portlet.vcms.model.VcmsLogger> models) {
		JSONArray jsonArray = JSONFactoryUtil.createJSONArray();
