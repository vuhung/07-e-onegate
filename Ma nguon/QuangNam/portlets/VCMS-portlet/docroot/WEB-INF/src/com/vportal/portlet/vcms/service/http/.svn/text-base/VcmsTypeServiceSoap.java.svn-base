...
public class VcmsTypeServiceSoap {
	...
	public static com.vportal.portlet.vcms.model.VcmsTypeSoap[] getTypesByS_L(
		long groupId, java.lang.String language) throws RemoteException {
		try {
			java.util.List returnValue = VcmsTypeServiceUtil.getTypesByS_L(groupId,
					language);

			return com.vportal.portlet.vcms.model.VcmsTypeSoap.toSoapModels(returnValue);
		}
		catch (Exception e) {
			_log.error(e, e);
