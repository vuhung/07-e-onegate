...
public class VcmsPARelationServiceSoap {
	...
	public static com.vportal.portlet.vcms.model.VcmsPARelationSoap[] getRelationsByPortion(
		java.lang.String portionId) throws RemoteException {
		try {
			java.util.List returnValue = VcmsPARelationServiceUtil.getRelationsByPortion(portionId);

			return com.vportal.portlet.vcms.model.VcmsPARelationSoap.toSoapModels(returnValue);
		}
		catch (Exception e) {
			_log.error(e, e);
	...
	public static com.vportal.portlet.vcms.model.VcmsPARelationSoap[] getRelationsByArticle(
		java.lang.String articleId) throws RemoteException {
		try {
			java.util.List returnValue = VcmsPARelationServiceUtil.getRelationsByArticle(articleId);
