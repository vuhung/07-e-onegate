 ...
 * @generated
 */
public class VcmsCategoryJSONSerializer {
	public static JSONObject toJSONObject(VcmsCategory model) {
	...
	public static JSONArray toJSONArray(
		com.vportal.portlet.vcms.model.VcmsCategory[] models) {
	...
	public static JSONArray toJSONArray(
		List<com.vportal.portlet.vcms.model.VcmsCategory> models) {
		JSONArray jsonArray = JSONFactoryUtil.createJSONArray();
