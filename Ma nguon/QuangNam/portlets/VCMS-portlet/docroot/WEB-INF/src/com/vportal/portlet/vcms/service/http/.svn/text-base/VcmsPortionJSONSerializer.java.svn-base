 ...
 * @generated
 */
public class VcmsPortionJSONSerializer {
	public static JSONObject toJSONObject(VcmsPortion model) {
		JSONObject jsonObj = JSONFactoryUtil.createJSONObject();

		jsonObj.put("portionId", model.getPortionId());
		...
		jsonObj.put("categorizable", model.getCategorizable());
	...
	public static JSONArray toJSONArray(
		com.vportal.portlet.vcms.model.VcmsPortion[] models) {
	...
	public static JSONArray toJSONArray(
		List<com.vportal.portlet.vcms.model.VcmsPortion> models) {
		JSONArray jsonArray = JSONFactoryUtil.createJSONArray();
