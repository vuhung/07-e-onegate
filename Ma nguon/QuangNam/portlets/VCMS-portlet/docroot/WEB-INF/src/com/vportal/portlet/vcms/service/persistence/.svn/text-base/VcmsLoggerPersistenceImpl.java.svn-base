...
public class VcmsLoggerPersistenceImpl extends BasePersistenceImpl<VcmsLogger>
	...
	public static final String FINDER_CLASS_NAME_LIST = FINDER_CLASS_NAME_ENTITY +
		".List";
	public static final FinderPath FINDER_PATH_FIND_BY_U_D = new FinderPath(VcmsLoggerModelImpl.ENTITY_CACHE_ENABLED,
			VcmsLoggerModelImpl.FINDER_CACHE_ENABLED, FINDER_CLASS_NAME_LIST,
			"findByU_D",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_FIND_ALL = new FinderPath(VcmsLoggerModelImpl.ENTITY_CACHE_ENABLED,
			VcmsLoggerModelImpl.FINDER_CACHE_ENABLED, FINDER_CLASS_NAME_LIST,
	...
	public void cacheResult(List<VcmsLogger> vcmsLoggers) {
		for (VcmsLogger vcmsLogger : vcmsLoggers) {
			if (EntityCacheUtil.getResult(
						...
						VcmsLoggerImpl.class, vcmsLogger.getPrimaryKey(), this) == null) {
	 ...
	 *
	 * @param primaryKey the primary key of the vcms logger to remove
	...
	/**
	 * Finds the vcms logger with the primary key or throws a {@link com.liferay.portal.NoSuchModelException} if it could not be found.
	 *
	 * @param primaryKey the primary key of the vcms logger to find
	...
	public VcmsLogger fetchByPrimaryKey(String loggerId)
		...
		VcmsLogger vcmsLogger = (VcmsLogger)EntityCacheUtil.getResult(VcmsLoggerModelImpl.ENTITY_CACHE_ENABLED,
				VcmsLoggerImpl.class, loggerId, this);
	...
	public List<VcmsLogger> findByU_D(String createdByUser, Date createdDate,
		...
		List<VcmsLogger> list = (List<VcmsLogger>)FinderCacheUtil.getResult(FINDER_PATH_FIND_BY_U_D,
				finderArgs, this);
	...
	protected VcmsLogger getByU_D_PrevAndNext(Session session,
		...
		if (orderByComparator != null) {
			Object[] values = orderByComparator.getOrderByValues(vcmsLogger);
	...
	public List<VcmsLogger> findAll(int start, int end,
		...
		List<VcmsLogger> list = (List<VcmsLogger>)FinderCacheUtil.getResult(FINDER_PATH_FIND_ALL,
				finderArgs, this);
