...
public class VcmsCategoryUtil {
	 ...
	 */
	public static VcmsCategory remove(VcmsCategory vcmsCategory)
		throws SystemException {
		return getPersistence().remove(vcmsCategory);
	}
	...
	*/
	...
	public static VcmsCategoryPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (VcmsCategoryPersistence)PortletBeanLocatorUtil.locate(com.vportal.portlet.vcms.service.ClpSerializer.SERVLET_CONTEXT_NAME,
