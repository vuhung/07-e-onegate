 ...
 * @author HOAN
 */
public class VcmsAttachedMessageServiceClp implements VcmsAttachedMessageService {
	public VcmsAttachedMessageServiceClp(ClassLoaderProxy classLoaderProxy) {
	...
	public com.vportal.portlet.vcms.model.VcmsAttachedMessage addMessage(
		...
		return (com.vportal.portlet.vcms.model.VcmsAttachedMessage)ClpSerializer.translateOutput(returnObj);
	}
	...
	public com.vportal.portlet.vcms.model.VcmsAttachedMessage getMessage(
		...
		MethodHandler methodHandler = new MethodHandler(_getMessageMethodKey5,
				messageId);
	...
	public java.util.List getMessages(java.lang.String[] messageIds)
		...
		MethodHandler methodHandler = new MethodHandler(_getMessagesMethodKey6,
				messageIds);
	...
	public java.util.List getByG_R(long groupId, boolean read)
		...
		MethodHandler methodHandler = new MethodHandler(_getByG_RMethodKey9,
				groupId, read);
	...
	public java.util.List getByG_R(long groupId, boolean read, int begin,
		...
		MethodHandler methodHandler = new MethodHandler(_getByG_RMethodKey10,
				groupId, read, begin, end);
	...
	public int countByG_R(long groupId, boolean read)
		...
		MethodHandler methodHandler = new MethodHandler(_countByG_RMethodKey11,
				groupId, read);
	...
	public java.util.List getMessagesUnread(boolean read)
		...
		MethodHandler methodHandler = new MethodHandler(_getMessagesUnreadMethodKey12,
				read);
	...
	public int count(java.lang.String articleId, boolean read)
		...
		MethodHandler methodHandler = new MethodHandler(_countMethodKey13,
				articleId, read);
	...
	private MethodKey _updateMessageMethodKey2 = new MethodKey(_classLoaderProxy.getClassName(),
			"updateMessage",
			com.vportal.portlet.vcms.model.VcmsAttachedMessage.class);
	...
	private MethodKey _getMessageMethodKey5 = new MethodKey(_classLoaderProxy.getClassName(),
			"getMessage", java.lang.String.class);
	private MethodKey _getMessagesMethodKey6 = new MethodKey(_classLoaderProxy.getClassName(),
	...
	private MethodKey _getByG_RMethodKey9 = new MethodKey(_classLoaderProxy.getClassName(),
			"getByG_R", long.class, boolean.class);
	private MethodKey _getByG_RMethodKey10 = new MethodKey(_classLoaderProxy.getClassName(),
			"getByG_R", long.class, boolean.class, int.class, int.class);
	private MethodKey _countByG_RMethodKey11 = new MethodKey(_classLoaderProxy.getClassName(),
			"countByG_R", long.class, boolean.class);
	private MethodKey _getMessagesUnreadMethodKey12 = new MethodKey(_classLoaderProxy.getClassName(),
			"getMessagesUnread", boolean.class);
	private MethodKey _countMethodKey13 = new MethodKey(_classLoaderProxy.getClassName(),
