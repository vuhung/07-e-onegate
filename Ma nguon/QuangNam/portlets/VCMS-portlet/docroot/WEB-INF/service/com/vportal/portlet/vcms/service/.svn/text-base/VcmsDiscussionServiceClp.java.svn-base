...
public class VcmsDiscussionServiceClp implements VcmsDiscussionService {
	...
	public com.vportal.portlet.vcms.model.VcmsDiscussion addDiscussion(
		...
		MethodHandler methodHandler = new MethodHandler(_addDiscussionMethodKey0,
				...
				articleId, title, content, hasAttachment, language,
	...
	public com.vportal.portlet.vcms.model.VcmsDiscussion updateDiscussion(
		...
		MethodHandler methodHandler = new MethodHandler(_updateDiscussionMethodKey1,
				discussionId, visitorName, visitorEmail, visitorPhone, groupId,
				companyId, articleId, title, content, hasAttachment, approved,
				language);
	...
	public java.util.List searchDiscussionByA_P_L_K(
		...
		MethodHandler methodHandler = new MethodHandler(_searchDiscussionByA_P_L_KMethodKey13,
				articleId, groupId, language, keyword, approved, isTitle,
				isContent, select);
	...
	private MethodKey _addDiscussionMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
			"addDiscussion", java.lang.String.class, java.lang.String.class,
			java.lang.String.class, long.class, long.class,
			java.lang.String.class, java.lang.String.class,
			java.lang.String.class, boolean.class, java.lang.String.class,
			boolean.class, boolean.class);
	private MethodKey _updateDiscussionMethodKey1 = new MethodKey(_classLoaderProxy.getClassName(),
			"updateDiscussion", java.lang.String.class, java.lang.String.class,
			java.lang.String.class, java.lang.String.class, long.class,
			long.class, java.lang.String.class, java.lang.String.class,
			java.lang.String.class, boolean.class, boolean.class,
			java.lang.String.class);
	private MethodKey _updateDiscussionMethodKey2 = new MethodKey(_classLoaderProxy.getClassName(),
			"updateDiscussion",
			com.vportal.portlet.vcms.model.VcmsDiscussion.class);
	private MethodKey _deleteDiscussionMethodKey3 = new MethodKey(_classLoaderProxy.getClassName(),
			"deleteDiscussion", java.lang.String.class);
	private MethodKey _deleteDiscussionsMethodKey4 = new MethodKey(_classLoaderProxy.getClassName(),
			"deleteDiscussions", java.lang.String[].class);
	private MethodKey _deleteDiscussionsMethodKey5 = new MethodKey(_classLoaderProxy.getClassName(),
			"deleteDiscussions", java.lang.String.class);
	private MethodKey _deleteDiscussionsMethodKey6 = new MethodKey(_classLoaderProxy.getClassName(),
			"deleteDiscussions", java.lang.String.class, boolean.class);
	private MethodKey _getDiscussionMethodKey7 = new MethodKey(_classLoaderProxy.getClassName(),
			"getDiscussion", java.lang.String.class);
	private MethodKey _getDiscussionsMethodKey8 = new MethodKey(_classLoaderProxy.getClassName(),
			"getDiscussions", java.lang.String.class);
	private MethodKey _getDiscussionsMethodKey9 = new MethodKey(_classLoaderProxy.getClassName(),
			"getDiscussions", java.lang.String.class, boolean.class);
	private MethodKey _getDiscussionsByP_LMethodKey10 = new MethodKey(_classLoaderProxy.getClassName(),
			"getDiscussionsByP_L", long.class, java.lang.String.class);
	private MethodKey _getDiscussionsByP_L_AMethodKey11 = new MethodKey(_classLoaderProxy.getClassName(),
			"getDiscussionsByP_L_A", long.class, java.lang.String.class,
			boolean.class);
	private MethodKey _getDiscussionsByA_P_L_AMethodKey12 = new MethodKey(_classLoaderProxy.getClassName(),
			"getDiscussionsByA_P_L_A", java.lang.String.class, long.class,
			java.lang.String.class, boolean.class);
	private MethodKey _searchDiscussionByA_P_L_KMethodKey13 = new MethodKey(_classLoaderProxy.getClassName(),
			"searchDiscussionByA_P_L_K", java.lang.String.class, long.class,
			java.lang.String.class, java.lang.String.class, boolean.class,
			boolean.class, boolean.class, java.lang.String.class);
	private MethodKey _countByApprovalMethodKey14 = new MethodKey(_classLoaderProxy.getClassName(),
			"countByApproval", long.class, java.lang.String.class, boolean.class);
}