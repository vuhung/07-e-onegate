...
public class VcmsTypeServiceClp implements VcmsTypeService {
	...
	public com.vportal.portlet.vcms.model.VcmsType addType(long groupId,
		...
		MethodHandler methodHandler = new MethodHandler(_addTypeMethodKey0,
				groupId, companyId, plid, code, name, description, language,
	...
	private MethodKey _addTypeMethodKey1 = new MethodKey(_classLoaderProxy.getClassName(),
			...
			java.lang.String[].class, java.lang.String[].class);
	private MethodKey _addTypeResourcesMethodKey2 = new MethodKey(_classLoaderProxy.getClassName(),
			"addTypeResources", java.lang.String.class, boolean.class,
			boolean.class);
	private MethodKey _addTypeResourcesMethodKey3 = new MethodKey(_classLoaderProxy.getClassName(),
			"addTypeResources", com.vportal.portlet.vcms.model.VcmsType.class,
			boolean.class, boolean.class);
	private MethodKey _addTypeResourcesMethodKey4 = new MethodKey(_classLoaderProxy.getClassName(),
			"addTypeResources", java.lang.String.class,
			java.lang.String[].class, java.lang.String[].class);
	private MethodKey _addTypeResourcesMethodKey5 = new MethodKey(_classLoaderProxy.getClassName(),
			"addTypeResources", com.vportal.portlet.vcms.model.VcmsType.class,
			java.lang.String[].class, java.lang.String[].class);
	private MethodKey _updateTypeMethodKey6 = new MethodKey(_classLoaderProxy.getClassName(),
			"updateType", java.lang.String.class, long.class, long.class,
			java.lang.String.class, java.lang.String.class,
			java.lang.String.class, java.lang.String.class);
	private MethodKey _deleteTypeMethodKey7 = new MethodKey(_classLoaderProxy.getClassName(),
			"deleteType", java.lang.String.class);
	private MethodKey _deleteTypesMethodKey8 = new MethodKey(_classLoaderProxy.getClassName(),
			"deleteTypes", java.lang.String[].class);
	private MethodKey _getTypeMethodKey9 = new MethodKey(_classLoaderProxy.getClassName(),
			"getType", java.lang.String.class);
	private MethodKey _getTypeByS_CMethodKey10 = new MethodKey(_classLoaderProxy.getClassName(),
			"getTypeByS_C", long.class, java.lang.String.class);
	private MethodKey _getTypesByS_LMethodKey11 = new MethodKey(_classLoaderProxy.getClassName(),
			"getTypesByS_L", long.class, java.lang.String.class);
	private MethodKey _getTypesByS_LMethodKey12 = new MethodKey(_classLoaderProxy.getClassName(),
			"getTypesByS_L", long.class, java.lang.String.class, int.class,
			int.class);
	private MethodKey _countTypesByS_LMethodKey13 = new MethodKey(_classLoaderProxy.getClassName(),
