...
public class VContactServiceClp implements VContactService {
	...
	public com.vportal.portlet.vcontact.model.VContact addContact(
		...
		MethodHandler methodHandler = new MethodHandler(_addContactMethodKey0,
				groupId, companyId, plid, guestName, email, title, address,
				phone, fax, content, hasAttach, status, userId,
	...
	public com.vportal.portlet.vcontact.model.VContact updateContact(long Id,
		...
		MethodHandler methodHandler = new MethodHandler(_updateContactMethodKey2,
				Id, groupId, companyId, guestName, email, title, address,
	...
	private MethodKey _addContactMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
			...
			java.lang.String[].class, java.lang.String[].class);
	private MethodKey _addContactMethodKey1 = new MethodKey(_classLoaderProxy.getClassName(),
			"addContact", long.class, long.class, long.class,
			java.lang.String.class, java.lang.String.class,
			java.lang.String.class, java.lang.String.class,
			java.lang.String.class, java.lang.String.class,
			...
			java.lang.String[].class, java.lang.String[].class);
	private MethodKey _updateContactMethodKey2 = new MethodKey(_classLoaderProxy.getClassName(),
			"updateContact", long.class, long.class, long.class,
			java.lang.String.class, java.lang.String.class,
			java.lang.String.class, java.lang.String.class,
			java.lang.String.class, java.lang.String.class,
			java.lang.String.class, boolean.class, int.class);
	private MethodKey _updateContactMethodKey3 = new MethodKey(_classLoaderProxy.getClassName(),
			"updateContact", com.vportal.portlet.vcontact.model.VContact.class);
	private MethodKey _deleteContactMethodKey4 = new MethodKey(_classLoaderProxy.getClassName(),
			"deleteContact", long.class);
	private MethodKey _getAllMethodKey5 = new MethodKey(_classLoaderProxy.getClassName(),
			"getAll");
	private MethodKey _getByStatusMethodKey6 = new MethodKey(_classLoaderProxy.getClassName(),
			"getByStatus", int.class);
	private MethodKey _getByG_SMethodKey7 = new MethodKey(_classLoaderProxy.getClassName(),
			"getByG_S", long.class, int.class);
	private MethodKey _getByG_SMethodKey8 = new MethodKey(_classLoaderProxy.getClassName(),
			"getByG_S", long.class, int.class, int.class, int.class);
	private MethodKey _getContactMethodKey9 = new MethodKey(_classLoaderProxy.getClassName(),
