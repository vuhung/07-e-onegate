...
package com.vportal.portal.service.messaging;
...
import com.vportal.portal.service.ClpSerializer;
import com.vportal.portal.service.PortletFolderLocalServiceUtil;
import com.vportal.portal.service.PortletFolderServiceUtil;
...
public class ClpMessageListener implements MessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			AccessCounterServiceUtil.clearService();
			PortletFolderLocalServiceUtil.clearService();

			PortletFolderServiceUtil.clearService();
		}
	}
