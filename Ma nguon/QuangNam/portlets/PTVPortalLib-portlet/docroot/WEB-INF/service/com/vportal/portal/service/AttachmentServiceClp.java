 ...
 * @author HOAN
 */
public class AttachmentServiceClp implements AttachmentService {
	public AttachmentServiceClp(ClassLoaderProxy classLoaderProxy) {
	...
	public com.vportal.portal.model.Attachment addAttachment(long companyId,
		...
		MethodHandler methodHandler = new MethodHandler(_addAttachmentMethodKey0,
				companyId, groupId, entryId, entryClass, folderId, fileName,
				byteArray);
	...
	public java.util.List getAttachments(long entryId,
		...
		MethodHandler methodHandler = new MethodHandler(_getAttachmentsMethodKey1,
				entryId, entryClass);
	...
	public java.util.List searchAttachments(long folderId,
		...
		MethodHandler methodHandler = new MethodHandler(_searchAttachmentsMethodKey2,
				folderId, keywords);
	...
	public void deleteAttachments(java.lang.Class entryClass, long entryId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		MethodHandler methodHandler = new MethodHandler(_deleteAttachmentsMethodKey4,
				entryClass, entryId);
	...
	private MethodKey _addAttachmentMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
			...
			java.lang.Class.class, long.class, java.lang.String.class,
			byte[].class);
	private MethodKey _getAttachmentsMethodKey1 = new MethodKey(_classLoaderProxy.getClassName(),
			"getAttachments", long.class, java.lang.Class.class);
	private MethodKey _searchAttachmentsMethodKey2 = new MethodKey(_classLoaderProxy.getClassName(),
			"searchAttachments", long.class, java.lang.String.class);
	...
	private MethodKey _deleteAttachmentsMethodKey4 = new MethodKey(_classLoaderProxy.getClassName(),
