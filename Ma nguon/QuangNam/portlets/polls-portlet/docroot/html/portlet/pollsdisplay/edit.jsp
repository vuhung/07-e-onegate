...
<%
	...
	PortletURL configs = renderResponse.createActionURL();
	configs.setParameter(ActionRequest.ACTION_NAME, "configs");
%>	
...
<form  action="<%=configs.toString()%>" name="<portlet:namespace />fm" method="POST">
