...
package com.vportal.portlet.pollsadmin.service.base;
...
import com.vportal.portlet.pollsadmin.service.PollsChoiceLocalService;
import com.vportal.portlet.pollsadmin.service.PollsQuestionExtService;
import com.vportal.portlet.pollsadmin.service.PollsQuestionLocalService;
import com.vportal.portlet.pollsadmin.service.PollsQuestionService;
import com.vportal.portlet.pollsadmin.service.PollsVoteLocalService;
import com.vportal.portlet.pollsadmin.service.PollsVoteService;
import com.vportal.portlet.pollsadmin.service.persistence.PollsChoicePersistence;
import com.vportal.portlet.pollsadmin.service.persistence.PollsQuestionPersistence;
import com.vportal.portlet.pollsadmin.service.persistence.PollsVotePersistence;

import javax.sql.DataSource;

/**
 * The base implementation of the polls question ext remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.vportal.portlet.pollsadmin.service.impl.PollsQuestionExtServiceImpl}.
 * </p>
 *
 * <p>
 * Never modify or reference this class directly. Always use {@link com.vportal.portlet.pollsadmin.service.PollsQuestionExtServiceUtil} to access the polls question ext remote service.
 * </p>
 *
 * @author ACB
 * @see com.vportal.portlet.pollsadmin.service.impl.PollsQuestionExtServiceImpl
 * @see com.vportal.portlet.pollsadmin.service.PollsQuestionExtServiceUtil
 * @generated
 */
public abstract class PollsQuestionExtServiceBaseImpl extends PrincipalBean
	implements PollsQuestionExtService {
	/**
	 * Gets the polls question ext remote service.
	 *
	 * @return the polls question ext remote service
	 */
	public PollsQuestionExtService getPollsQuestionExtService() {
		return pollsQuestionExtService;
	}

	/**
	 * Sets the polls question ext remote service.
	 *
	 * @param pollsQuestionExtService the polls question ext remote service
	 */
	public void setPollsQuestionExtService(
		PollsQuestionExtService pollsQuestionExtService) {
		this.pollsQuestionExtService = pollsQuestionExtService;
	}
	...
	@BeanReference(type = PollsQuestionExtService.class)
	protected PollsQuestionExtService pollsQuestionExtService;
