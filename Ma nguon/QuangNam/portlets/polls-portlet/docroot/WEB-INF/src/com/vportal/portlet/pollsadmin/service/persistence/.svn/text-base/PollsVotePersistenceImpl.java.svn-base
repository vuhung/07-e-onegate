...
import com.vportal.portlet.pollsadmin.NoSuchPollsVoteException;
import com.vportal.portlet.pollsadmin.model.PollsVote;
import com.vportal.portlet.pollsadmin.model.impl.PollsVoteImpl;
import com.vportal.portlet.pollsadmin.model.impl.PollsVoteModelImpl;
...
public class PollsVotePersistenceImpl extends BasePersistenceImpl<PollsVote>
	 ...
	 * @return the polls vote that was removed
	 * @throws com.vportal.portlet.pollsadmin.NoSuchPollsVoteException if a polls vote with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public PollsVote remove(long voteId)
		throws NoSuchPollsVoteException, SystemException {
		...
		try {
			...
			if (pollsVote == null) {
				...
				throw new NoSuchPollsVoteException(_NO_SUCH_ENTITY_WITH_PRIMARY_KEY +
					voteId);
			}

			return remove(pollsVote);
		}
		catch (NoSuchPollsVoteException nsee) {
			throw nsee;
		}
		catch (Exception e) {
	...
	public PollsVote updateImpl(
		com.vportal.portlet.pollsadmin.model.PollsVote pollsVote, boolean merge)
		throws SystemException {
		pollsVote = toUnwrappedModel(pollsVote);
	...
	/**
	 * Finds the polls vote with the primary key or throws a {@link com.vportal.portlet.pollsadmin.NoSuchPollsVoteException} if it could not be found.
	 *
	 ...
	 * @throws com.vportal.portlet.pollsadmin.NoSuchPollsVoteException if a matching polls vote could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public PollsVote findByQuestionId_First(long questionId,
		...
		if (list.isEmpty()) {
			...
			throw new NoSuchPollsVoteException(msg.toString());
		}
		else {
			return list.get(0);
		}
	...
	/**
	 * Finds the polls vote where questionId = &#63; and userId = &#63; or throws a {@link com.vportal.portlet.pollsadmin.NoSuchPollsVoteException} if it could not be found.
	 *
	 * @param questionId the question id to search with
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.vportal.portlet.pollsadmin.model.PollsVote")));
