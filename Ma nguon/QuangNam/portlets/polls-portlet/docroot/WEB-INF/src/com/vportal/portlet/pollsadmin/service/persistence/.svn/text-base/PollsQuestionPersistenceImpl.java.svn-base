...
import com.vportal.portlet.pollsadmin.NoSuchPollsQuestionException;
...
import com.vportal.portlet.pollsadmin.model.impl.PollsQuestionModelImpl;
...
public class PollsQuestionPersistenceImpl extends BasePersistenceImpl<PollsQuestion>
	 ...
	 * @return the polls question that was removed
	 * @throws com.vportal.portlet.pollsadmin.NoSuchPollsQuestionException if a polls question with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public PollsQuestion remove(long questionId)
		throws NoSuchPollsQuestionException, SystemException {
		...
		try {
			...
			if (pollsQuestion == null) {
				...
				throw new NoSuchPollsQuestionException(_NO_SUCH_ENTITY_WITH_PRIMARY_KEY +
					questionId);
			}

			return remove(pollsQuestion);
		}
		catch (NoSuchPollsQuestionException nsee) {
			throw nsee;
		}
		catch (Exception e) {
	...
	public PollsQuestion updateImpl(
		com.vportal.portlet.pollsadmin.model.PollsQuestion pollsQuestion,
	...
	/**
	 * Finds the polls question with the primary key or throws a {@link com.vportal.portlet.pollsadmin.NoSuchPollsQuestionException} if it could not be found.
	 *
	 ...
	 * @throws com.vportal.portlet.pollsadmin.NoSuchPollsQuestionException if a matching polls question could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public PollsQuestion findByUuid_First(String uuid,
		...
		if (list.isEmpty()) {
			...
			throw new NoSuchPollsQuestionException(msg.toString());
		}
		else {
			return list.get(0);
		}
	...
	/**
	 * Finds the polls question where uuid = &#63; and groupId = &#63; or throws a {@link com.vportal.portlet.pollsadmin.NoSuchPollsQuestionException} if it could not be found.
	 *
	 * @param uuid the uuid to search with
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.vportal.portlet.pollsadmin.model.PollsQuestion")));
