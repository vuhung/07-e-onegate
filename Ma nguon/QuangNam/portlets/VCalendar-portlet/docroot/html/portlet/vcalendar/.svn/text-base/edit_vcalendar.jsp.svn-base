...
mondayURL.setParameter("jspPage","/vcalendar/edit_event");
...
tuesdayURL.setParameter("jspPage","/html/portlet/vcalendar/edit_vcalendar.jsp");
...
webdayURL.setParameter("jspPage","/html/portlet/vcalendar/edit_vcalendar.jsp");
...
thusdayURL.setParameter("jspPage","/html/portlet/vcalendar/edit_vcalendar.jsp");
...
fridayURL.setParameter("jspPage","/html/portlet/vcalendar/edit_vcalendar.jsp");
...
satdayURL.setParameter("jspPage","/html/portlet/vcalendar/edit_vcalendar.jsp");
...
sundayURL.setParameter("jspPage","/html/portlet/vcalendar/edit_vcalendar.jsp");
...
<script language="javascript" type="text/javascript">
 function <portlet:namespace />ckshowtime(){
  ...
  function <portlet:namespace />saveVcal(){
		<%-- submitForm(document.<portlet:namespace />fm, '<portlet:actionURL windowState="<%= WindowState.MAXIMIZED.toString() %>"><portlet:param name="struts_action" value="/html/portlet/vcalendar/edit_vcalendar.jsp" /><portlet:param name="month" value="<%= String.valueOf(selMonth) %>" /><portlet:param name="action" value="add_action" /><portlet:param name="status" value="<%= String.valueOf(status) %>" /><portlet:param name="day" value="<%= String.valueOf(selDay) %>" /><portlet:param name="year" value="<%= String.valueOf(selYear) %>" /></portlet:actionURL>'); --%>
		submitForm(document.<portlet:namespace />fm, '<portlet:actionURL windowState="<%=WindowState.MAXIMIZED.toString()%>" name="_addvCal"></portlet:actionURL>');
  }
  ...
  function <portlet:namespace />submitForm(value){				
	...
	self.location = '<portlet:renderURL windowState="<%= WindowState.MAXIMIZED.toString() %>"><portlet:param name="jspPage" value="/html/portlet/vcalendar/edit_vcalendar.jsp" /></portlet:renderURL>&<portlet:namespace />status=<%=status%>&<portlet:namespace />month=' + (value_array[1]-1) + '&<portlet:namespace />day=' + value_array[0] + '&<portlet:namespace />year=' + value_array[2];
}
