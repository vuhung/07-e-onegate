...
public class VFilePersistenceImpl extends BasePersistenceImpl<VFile>
	...
	public static final String FINDER_CLASS_NAME_LIST = FINDER_CLASS_NAME_ENTITY +
		".List";
	public static final FinderPath FINDER_PATH_FIND_BY_GROUPID = new FinderPath(VFileModelImpl.ENTITY_CACHE_ENABLED,
			VFileModelImpl.FINDER_CACHE_ENABLED, FINDER_CLASS_NAME_LIST,
			"findByGroupID",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_GROUPID = new FinderPath(VFileModelImpl.ENTITY_CACHE_ENABLED,
			VFileModelImpl.FINDER_CACHE_ENABLED, FINDER_CLASS_NAME_LIST,
			"countByGroupID", new String[] { Integer.class.getName() });
	public static final FinderPath FINDER_PATH_FIND_ALL = new FinderPath(VFileModelImpl.ENTITY_CACHE_ENABLED,
			VFileModelImpl.FINDER_CACHE_ENABLED, FINDER_CLASS_NAME_LIST,
	...
	public void cacheResult(List<VFile> vFiles) {
		for (VFile vFile : vFiles) {
			if (EntityCacheUtil.getResult(VFileModelImpl.ENTITY_CACHE_ENABLED,
						VFileImpl.class, vFile.getPrimaryKey(), this) == null) {
				cacheResult(vFile);
			}
		}
	}
	 ...
	 *
	 * @param primaryKey the primary key of the v file to remove
	...
	public VFile remove(long fileId)
		...
		try {
			...
			VFile vFile = (VFile)session.get(VFileImpl.class, new Long(fileId));
	...
	/**
	 * Finds the v file with the primary key or throws a {@link com.liferay.portal.NoSuchModelException} if it could not be found.
	 *
	 * @param primaryKey the primary key of the v file to find
	 * @return the v file
	 * @throws com.liferay.portal.NoSuchModelException if a v file with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	...
	public VFile fetchByPrimaryKey(long fileId) throws SystemException {
		...
		if (vFile == null) {
			...
			try {
				...
				vFile = (VFile)session.get(VFileImpl.class, new Long(fileId));
			}
			catch (Exception e) {
				throw processException(e);
			}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<VFile> findByGroupID(int status) throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<VFile> findByGroupID(int status, int start, int end)
		throws SystemException {
	...
	public List<VFile> findByGroupID(int status, int start, int end,
		...
		List<VFile> list = (List<VFile>)FinderCacheUtil.getResult(FINDER_PATH_FIND_BY_GROUPID,
				finderArgs, this);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public VFile findByGroupID_First(int status,
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public VFile findByGroupID_Last(int status,
		OrderByComparator orderByComparator)
		throws NoSuchVFileException, SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public VFile[] findByGroupID_PrevAndNext(long fileId, int status,
		OrderByComparator orderByComparator)
		throws NoSuchVFileException, SystemException {
	...
	protected VFile getByGroupID_PrevAndNext(Session session, VFile vFile,
		...
		if (orderByComparator != null) {
			Object[] values = orderByComparator.getOrderByValues(vFile);
	...
	public List<VFile> findAll(int start, int end,
		...
		List<VFile> list = (List<VFile>)FinderCacheUtil.getResult(FINDER_PATH_FIND_ALL,
				finderArgs, this);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByGroupID(int status) throws SystemException {
