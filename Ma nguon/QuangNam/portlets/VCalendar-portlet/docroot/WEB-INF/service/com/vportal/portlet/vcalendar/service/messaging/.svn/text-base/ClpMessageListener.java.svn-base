...
package com.vportal.portlet.vcalendar.service.messaging;
...
import com.vportal.portlet.vcalendar.service.ClpSerializer;
import com.vportal.portlet.vcalendar.service.VCalLocalServiceUtil;
...
public class ClpMessageListener implements MessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			VCalLocalServiceUtil.clearService();

			VCalServiceUtil.clearService();

			VFileServiceUtil.clearService();
		}
	}
