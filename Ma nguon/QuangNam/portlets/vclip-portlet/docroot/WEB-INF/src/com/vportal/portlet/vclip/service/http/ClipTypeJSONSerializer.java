 ...
 * @generated
 */
public class ClipTypeJSONSerializer {
	public static JSONObject toJSONObject(ClipType model) {
	...
	public static JSONArray toJSONArray(
		com.vportal.portlet.vclip.model.ClipType[] models) {
	...
	public static JSONArray toJSONArray(
		List<com.vportal.portlet.vclip.model.ClipType> models) {
		JSONArray jsonArray = JSONFactoryUtil.createJSONArray();
