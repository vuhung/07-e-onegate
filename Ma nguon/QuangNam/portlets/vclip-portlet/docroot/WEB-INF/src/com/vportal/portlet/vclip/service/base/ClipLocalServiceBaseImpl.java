...
/**
 * The base implementation of the clip local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.vportal.portlet.vclip.service.impl.ClipLocalServiceImpl}.
 * </p>
 *
 * <p>
 * Never modify or reference this class directly. Always use {@link com.vportal.portlet.vclip.service.ClipLocalServiceUtil} to access the clip local service.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ClipLocalServiceBaseImpl implements ClipLocalService {
	/**
	 ...
	 */
	public Clip addClip(Clip clip) throws SystemException {
		clip.setNew(true);

		return clipPersistence.update(clip, false);
	}
	 ...
	 * @return the new clip
	 */
	public Clip createClip(String id) {
		return clipPersistence.create(id);
	}

	/**
	 * Deletes the clip with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param id the primary key of the clip to delete
	 * @throws PortalException if a clip with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteClip(String id) throws PortalException, SystemException {
		clipPersistence.remove(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteClip(Clip clip) throws SystemException {
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return clipPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return clipPersistence.countWithDynamicQuery(dynamicQuery);
	}

	/**
	 * Gets the clip with the primary key.
	 *
	 * @param id the primary key of the clip to get
	 * @return the clip
	 * @throws PortalException if a clip with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public Clip getClip(String id) throws PortalException, SystemException {
		return clipPersistence.findByPrimaryKey(id);
	}

	/**
	 * Gets a range of all the clips.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Clip> getClips(int start, int end) throws SystemException {
		return clipPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getClipsCount() throws SystemException {
		return clipPersistence.countAll();
	}

	/**
	 * Updates the clip in the database. Also notifies the appropriate model listeners.
	 *
	 * @param clip the clip to update
	 * @return the clip that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public Clip updateClip(Clip clip) throws SystemException {
		clip.setNew(false);

		return clipPersistence.update(clip, true);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Clip updateClip(Clip clip, boolean merge) throws SystemException {
		clip.setNew(false);

		return clipPersistence.update(clip, merge);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = clipPersistence.getDataSource();
