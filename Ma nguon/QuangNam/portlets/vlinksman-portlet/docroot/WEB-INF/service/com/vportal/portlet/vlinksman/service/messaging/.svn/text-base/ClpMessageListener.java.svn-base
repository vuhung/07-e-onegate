...
package com.vportal.portlet.vlinksman.service.messaging;
...
import com.vportal.portlet.vlinksman.service.ClpSerializer;
...
public class ClpMessageListener implements MessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			LinkGroupServiceUtil.clearService();

			LinksServiceUtil.clearService();
		}
	}
