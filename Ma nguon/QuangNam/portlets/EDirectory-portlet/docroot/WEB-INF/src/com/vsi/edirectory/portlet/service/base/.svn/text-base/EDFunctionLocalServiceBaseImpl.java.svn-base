...
/**
 * The base implementation of the e d function local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.vsi.edirectory.portlet.service.impl.EDFunctionLocalServiceImpl}.
 * </p>
 *
 * <p>
 * Never modify or reference this class directly. Always use {@link com.vsi.edirectory.portlet.service.EDFunctionLocalServiceUtil} to access the e d function local service.
 * </p>
 *
 * @author vinhnt
 * @see com.vsi.edirectory.portlet.service.impl.EDFunctionLocalServiceImpl
 * @see com.vsi.edirectory.portlet.service.EDFunctionLocalServiceUtil
 * @generated
 */
public abstract class EDFunctionLocalServiceBaseImpl
	implements EDFunctionLocalService {
	/**
	 * Adds the e d function to the database. Also notifies the appropriate model listeners.
	 *
	 * @param edFunction the e d function to add
	 * @return the e d function that was added
	 * @throws SystemException if a system exception occurred
	 */
	public EDFunction addEDFunction(EDFunction edFunction)
	 ...
	 */
	public EDFunction createEDFunction(long id) {
		return edFunctionPersistence.create(id);
	}

	/**
	 * Deletes the e d function with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param id the primary key of the e d function to delete
	...
	public void deleteEDFunction(long id)
		...
		edFunctionPersistence.remove(id);
	}

	/**
	 * Deletes the e d function from the database. Also notifies the appropriate model listeners.
	 *
	 * @param edFunction the e d function to delete
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteEDFunction(EDFunction edFunction)
		throws SystemException {
		edFunctionPersistence.remove(edFunction);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return edFunctionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return edFunctionPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return edFunctionPersistence.countWithDynamicQuery(dynamicQuery);
	}

	/**
	 * Gets the e d function with the primary key.
	 *
	 * @param id the primary key of the e d function to get
	 * @return the e d function
	 * @throws PortalException if a e d function with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public EDFunction getEDFunction(long id)
		throws PortalException, SystemException {
		return edFunctionPersistence.findByPrimaryKey(id);
	}

	/**
	 * Gets a range of all the e d functions.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<EDFunction> getEDFunctions(int start, int end)
		throws SystemException {
		return edFunctionPersistence.findAll(start, end);
	}

	/**
	 * Gets the number of e d functions.
	 *
	 * @return the number of e d functions
	 * @throws SystemException if a system exception occurred
	 */
	public int getEDFunctionsCount() throws SystemException {
		return edFunctionPersistence.countAll();
	}

	/**
	 * Updates the e d function in the database. Also notifies the appropriate model listeners.
	 *
	 * @param edFunction the e d function to update
	 * @return the e d function that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public EDFunction updateEDFunction(EDFunction edFunction)
		throws SystemException {
		edFunction.setNew(false);

		return edFunctionPersistence.update(edFunction, true);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public EDFunction updateEDFunction(EDFunction edFunction, boolean merge)
		throws SystemException {
		edFunction.setNew(false);

		return edFunctionPersistence.update(edFunction, merge);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = edFunctionPersistence.getDataSource();
