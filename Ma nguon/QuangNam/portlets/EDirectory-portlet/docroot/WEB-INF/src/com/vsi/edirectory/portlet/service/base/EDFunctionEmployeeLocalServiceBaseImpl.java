...
/**
 * The base implementation of the e d function employee local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.vsi.edirectory.portlet.service.impl.EDFunctionEmployeeLocalServiceImpl}.
 * </p>
 *
 * <p>
 * Never modify or reference this class directly. Always use {@link com.vsi.edirectory.portlet.service.EDFunctionEmployeeLocalServiceUtil} to access the e d function employee local service.
 * </p>
 *
 * @author vinhnt
 * @see com.vsi.edirectory.portlet.service.impl.EDFunctionEmployeeLocalServiceImpl
 * @see com.vsi.edirectory.portlet.service.EDFunctionEmployeeLocalServiceUtil
 * @generated
 */
public abstract class EDFunctionEmployeeLocalServiceBaseImpl
	 ...
	 *
	 * @param edFunctionEmployee the e d function employee to add
	 * @return the e d function employee that was added
	 * @throws SystemException if a system exception occurred
	 */
	public EDFunctionEmployee addEDFunctionEmployee(
		EDFunctionEmployee edFunctionEmployee) throws SystemException {
		edFunctionEmployee.setNew(true);

		return edFunctionEmployeePersistence.update(edFunctionEmployee, false);
	}
	 ...
	 */
	public EDFunctionEmployee createEDFunctionEmployee(long id) {
		return edFunctionEmployeePersistence.create(id);
	}

	/**
	 * Deletes the e d function employee with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param id the primary key of the e d function employee to delete
	...
	public void deleteEDFunctionEmployee(long id)
		...
		edFunctionEmployeePersistence.remove(id);
	}

	/**
	 * Deletes the e d function employee from the database. Also notifies the appropriate model listeners.
	 *
	 * @param edFunctionEmployee the e d function employee to delete
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteEDFunctionEmployee(EDFunctionEmployee edFunctionEmployee)
		throws SystemException {
		edFunctionEmployeePersistence.remove(edFunctionEmployee);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return edFunctionEmployeePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return edFunctionEmployeePersistence.countWithDynamicQuery(dynamicQuery);
	}

	/**
	 * Gets the e d function employee with the primary key.
	 *
	 * @param id the primary key of the e d function employee to get
	 * @return the e d function employee
	 * @throws PortalException if a e d function employee with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public EDFunctionEmployee getEDFunctionEmployee(long id)
		throws PortalException, SystemException {
		return edFunctionEmployeePersistence.findByPrimaryKey(id);
	}

	/**
	 * Gets a range of all the e d function employees.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<EDFunctionEmployee> getEDFunctionEmployees(int start, int end)
		throws SystemException {
		return edFunctionEmployeePersistence.findAll(start, end);
	}

	/**
	 * Gets the number of e d function employees.
	 *
	 * @return the number of e d function employees
	 * @throws SystemException if a system exception occurred
	 */
	public int getEDFunctionEmployeesCount() throws SystemException {
		return edFunctionEmployeePersistence.countAll();
	}

	/**
	 * Updates the e d function employee in the database. Also notifies the appropriate model listeners.
	 *
	 * @param edFunctionEmployee the e d function employee to update
	 * @return the e d function employee that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public EDFunctionEmployee updateEDFunctionEmployee(
		EDFunctionEmployee edFunctionEmployee) throws SystemException {
		edFunctionEmployee.setNew(false);

		return edFunctionEmployeePersistence.update(edFunctionEmployee, true);
	}
	...
	public EDFunctionEmployee updateEDFunctionEmployee(
		...
		return edFunctionEmployeePersistence.update(edFunctionEmployee, merge);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = edFunctionEmployeePersistence.getDataSource();
