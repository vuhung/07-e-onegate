...
/**
 * The base implementation of the e d department local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.vsi.edirectory.portlet.service.impl.EDDepartmentLocalServiceImpl}.
 * </p>
 *
 * <p>
 * Never modify or reference this class directly. Always use {@link com.vsi.edirectory.portlet.service.EDDepartmentLocalServiceUtil} to access the e d department local service.
 * </p>
 *
 * @author vinhnt
 * @see com.vsi.edirectory.portlet.service.impl.EDDepartmentLocalServiceImpl
 * @see com.vsi.edirectory.portlet.service.EDDepartmentLocalServiceUtil
 * @generated
 */
public abstract class EDDepartmentLocalServiceBaseImpl
	implements EDDepartmentLocalService {
	/**
	 * Adds the e d department to the database. Also notifies the appropriate model listeners.
	 *
	 * @param edDepartment the e d department to add
	 * @return the e d department that was added
	 * @throws SystemException if a system exception occurred
	 */
	public EDDepartment addEDDepartment(EDDepartment edDepartment)
		throws SystemException {
		edDepartment.setNew(true);

		return edDepartmentPersistence.update(edDepartment, false);
	}
	 ...
	 */
	public EDDepartment createEDDepartment(long id) {
		return edDepartmentPersistence.create(id);
	}

	/**
	 * Deletes the e d department with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param id the primary key of the e d department to delete
	...
	public void deleteEDDepartment(long id)
		...
		edDepartmentPersistence.remove(id);
	}

	/**
	 * Deletes the e d department from the database. Also notifies the appropriate model listeners.
	 *
	 * @param edDepartment the e d department to delete
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteEDDepartment(EDDepartment edDepartment)
		throws SystemException {
		edDepartmentPersistence.remove(edDepartment);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return edDepartmentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return edDepartmentPersistence.countWithDynamicQuery(dynamicQuery);
	}

	/**
	 * Gets the e d department with the primary key.
	 *
	 * @param id the primary key of the e d department to get
	 * @return the e d department
	 * @throws PortalException if a e d department with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public EDDepartment getEDDepartment(long id)
		throws PortalException, SystemException {
		return edDepartmentPersistence.findByPrimaryKey(id);
	}

	/**
	 * Gets a range of all the e d departments.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<EDDepartment> getEDDepartments(int start, int end)
		throws SystemException {
		return edDepartmentPersistence.findAll(start, end);
	}

	/**
	 * Gets the number of e d departments.
	 *
	 * @return the number of e d departments
	 * @throws SystemException if a system exception occurred
	 */
	public int getEDDepartmentsCount() throws SystemException {
		return edDepartmentPersistence.countAll();
	}

	/**
	 * Updates the e d department in the database. Also notifies the appropriate model listeners.
	 *
	 * @param edDepartment the e d department to update
	 * @return the e d department that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public EDDepartment updateEDDepartment(EDDepartment edDepartment)
		throws SystemException {
		edDepartment.setNew(false);

		return edDepartmentPersistence.update(edDepartment, true);
	}
	...
	public EDDepartment updateEDDepartment(EDDepartment edDepartment,
		...
		return edDepartmentPersistence.update(edDepartment, merge);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = edDepartmentPersistence.getDataSource();
