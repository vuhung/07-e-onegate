...
/**
 * The base implementation of the e d employee local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.vsi.edirectory.portlet.service.impl.EDEmployeeLocalServiceImpl}.
 * </p>
 *
 * <p>
 * Never modify or reference this class directly. Always use {@link com.vsi.edirectory.portlet.service.EDEmployeeLocalServiceUtil} to access the e d employee local service.
 * </p>
 *
 * @author vinhnt
 * @see com.vsi.edirectory.portlet.service.impl.EDEmployeeLocalServiceImpl
 * @see com.vsi.edirectory.portlet.service.EDEmployeeLocalServiceUtil
 * @generated
 */
public abstract class EDEmployeeLocalServiceBaseImpl
	implements EDEmployeeLocalService {
	/**
	 * Adds the e d employee to the database. Also notifies the appropriate model listeners.
	 *
	 * @param edEmployee the e d employee to add
	 * @return the e d employee that was added
	 * @throws SystemException if a system exception occurred
	 */
	public EDEmployee addEDEmployee(EDEmployee edEmployee)
		throws SystemException {
		edEmployee.setNew(true);

		return edEmployeePersistence.update(edEmployee, false);
	}
	 ...
	 */
	public EDEmployee createEDEmployee(long id) {
		return edEmployeePersistence.create(id);
	}

	/**
	 * Deletes the e d employee with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param id the primary key of the e d employee to delete
	...
	public void deleteEDEmployee(long id)
		...
		edEmployeePersistence.remove(id);
	}

	/**
	 * Deletes the e d employee from the database. Also notifies the appropriate model listeners.
	 *
	 * @param edEmployee the e d employee to delete
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteEDEmployee(EDEmployee edEmployee)
		throws SystemException {
		edEmployeePersistence.remove(edEmployee);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return edEmployeePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return edEmployeePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return edEmployeePersistence.countWithDynamicQuery(dynamicQuery);
	}

	/**
	 * Gets the e d employee with the primary key.
	 *
	 * @param id the primary key of the e d employee to get
	 * @return the e d employee
	 * @throws PortalException if a e d employee with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public EDEmployee getEDEmployee(long id)
		throws PortalException, SystemException {
		return edEmployeePersistence.findByPrimaryKey(id);
	}

	/**
	 * Gets the e d employee with the UUID and group id.
	 *
	 * @param uuid the UUID of e d employee to get
	 * @param groupId the group id of the e d employee to get
	 * @return the e d employee
	 * @throws PortalException if a e d employee with the UUID and group id could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public EDEmployee getEDEmployeeByUuidAndGroupId(String uuid, long groupId)
		throws PortalException, SystemException {
		return edEmployeePersistence.findByUUID_G(uuid, groupId);
	}

	/**
	 * Gets a range of all the e d employees.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<EDEmployee> getEDEmployees(int start, int end)
		throws SystemException {
		return edEmployeePersistence.findAll(start, end);
	}

	/**
	 * Gets the number of e d employees.
	 *
	 * @return the number of e d employees
	 * @throws SystemException if a system exception occurred
	 */
	public int getEDEmployeesCount() throws SystemException {
		return edEmployeePersistence.countAll();
	}

	/**
	 * Updates the e d employee in the database. Also notifies the appropriate model listeners.
	 *
	 * @param edEmployee the e d employee to update
	 * @return the e d employee that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public EDEmployee updateEDEmployee(EDEmployee edEmployee)
		throws SystemException {
		edEmployee.setNew(false);

		return edEmployeePersistence.update(edEmployee, true);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public EDEmployee updateEDEmployee(EDEmployee edEmployee, boolean merge)
		throws SystemException {
		edEmployee.setNew(false);

		return edEmployeePersistence.update(edEmployee, merge);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = edEmployeePersistence.getDataSource();
