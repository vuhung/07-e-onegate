 ...
 * @generated
 */
public class vdocOrgJSONSerializer {
	public static JSONObject toJSONObject(vdocOrg model) {
	...
	public static JSONArray toJSONArray(com.portlet.vdoc.model.vdocOrg[] models) {
	...
	public static JSONArray toJSONArray(
		com.portlet.vdoc.model.vdocOrg[][] models) {
		JSONArray jsonArray = JSONFactoryUtil.createJSONArray();
	...
	public static JSONArray toJSONArray(
		List<com.portlet.vdoc.model.vdocOrg> models) {
		JSONArray jsonArray = JSONFactoryUtil.createJSONArray();
