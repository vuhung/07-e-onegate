...
/**
 * The base implementation of the vdoc org local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.portlet.vdoc.service.impl.vdocOrgLocalServiceImpl}.
 * </p>
 *
 * <p>
 * Never modify or reference this class directly. Always use {@link com.portlet.vdoc.service.vdocOrgLocalServiceUtil} to access the vdoc org local service.
 * </p>
 *
 * @author vinhnt
 * @see com.portlet.vdoc.service.impl.vdocOrgLocalServiceImpl
 * @see com.portlet.vdoc.service.vdocOrgLocalServiceUtil
 * @generated
 */
public abstract class vdocOrgLocalServiceBaseImpl implements vdocOrgLocalService {
	/**
	 * Adds the vdoc org to the database. Also notifies the appropriate model listeners.
	 *
	 * @param vdocOrg the vdoc org to add
	 * @return the vdoc org that was added
	 * @throws SystemException if a system exception occurred
	 */
	public vdocOrg addvdocOrg(vdocOrg vdocOrg) throws SystemException {
		vdocOrg.setNew(true);

		return vdocOrgPersistence.update(vdocOrg, false);
	}
	 ...
	 *
	 * @param vdocOrg the vdoc org to delete
	 * @throws SystemException if a system exception occurred
	 */
	public void deletevdocOrg(vdocOrg vdocOrg) throws SystemException {
		vdocOrgPersistence.remove(vdocOrg);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return vdocOrgPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return vdocOrgPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return vdocOrgPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return vdocOrgPersistence.countWithDynamicQuery(dynamicQuery);
	}

	/**
	 * Gets the vdoc org with the primary key.
	 *
	 * @param orgId the primary key of the vdoc org to get
	 * @return the vdoc org
	 * @throws PortalException if a vdoc org with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public vdocOrg getvdocOrg(String orgId)
		throws PortalException, SystemException {
		return vdocOrgPersistence.findByPrimaryKey(orgId);
	}

	/**
	 * Gets a range of all the vdoc orgs.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	...
	public List<vdocOrg> getvdocOrgs(int start, int end)
		throws SystemException {
		return vdocOrgPersistence.findAll(start, end);
	}

	/**
	 * Gets the number of vdoc orgs.
	 *
	 * @return the number of vdoc orgs
	 * @throws SystemException if a system exception occurred
	 */
	public int getvdocOrgsCount() throws SystemException {
		return vdocOrgPersistence.countAll();
	}

	/**
	 * Updates the vdoc org in the database. Also notifies the appropriate model listeners.
	 *
	 * @param vdocOrg the vdoc org to update
	 * @return the vdoc org that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public vdocOrg updatevdocOrg(vdocOrg vdocOrg) throws SystemException {
		vdocOrg.setNew(false);

		return vdocOrgPersistence.update(vdocOrg, true);
	}
	 ...
	 *
	 * @param vdocOrg the vdoc org to update
	 * @param merge whether to merge the vdoc org with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the vdoc org that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public vdocOrg updatevdocOrg(vdocOrg vdocOrg, boolean merge)
		throws SystemException {
		vdocOrg.setNew(false);

		return vdocOrgPersistence.update(vdocOrg, merge);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = vdocOrgPersistence.getDataSource();
