...
/**
 * The base implementation of the vdoc document local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.portlet.vdoc.service.impl.vdocDocumentLocalServiceImpl}.
 * </p>
 *
 * <p>
 * Never modify or reference this class directly. Always use {@link com.portlet.vdoc.service.vdocDocumentLocalServiceUtil} to access the vdoc document local service.
 * </p>
 *
 * @author vinhnt
 * @see com.portlet.vdoc.service.impl.vdocDocumentLocalServiceImpl
 * @see com.portlet.vdoc.service.vdocDocumentLocalServiceUtil
 * @generated
 */
public abstract class vdocDocumentLocalServiceBaseImpl
	implements vdocDocumentLocalService {
	/**
	 * Adds the vdoc document to the database. Also notifies the appropriate model listeners.
	 *
	 * @param vdocDocument the vdoc document to add
	...
	public vdocDocument addvdocDocument(vdocDocument vdocDocument)
		...
		return vdocDocumentPersistence.update(vdocDocument, false);
	}
	 ...
	 */
	public vdocDocument createvdocDocument(String docId) {
		return vdocDocumentPersistence.create(docId);
	}

	/**
	 * Deletes the vdoc document with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param docId the primary key of the vdoc document to delete
	 * @throws PortalException if a vdoc document with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public void deletevdocDocument(String docId)
		throws PortalException, SystemException {
		vdocDocumentPersistence.remove(docId);
	}

	/**
	 * Deletes the vdoc document from the database. Also notifies the appropriate model listeners.
	 *
	 * @param vdocDocument the vdoc document to delete
	 * @throws SystemException if a system exception occurred
	 */
	public void deletevdocDocument(vdocDocument vdocDocument)
		throws SystemException {
		vdocDocumentPersistence.remove(vdocDocument);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return vdocDocumentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return vdocDocumentPersistence.countWithDynamicQuery(dynamicQuery);
	}

	/**
	 * Gets the vdoc document with the primary key.
	 *
	 * @param docId the primary key of the vdoc document to get
	 * @return the vdoc document
	 * @throws PortalException if a vdoc document with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public vdocDocument getvdocDocument(String docId)
		throws PortalException, SystemException {
		return vdocDocumentPersistence.findByPrimaryKey(docId);
	}

	/**
	 * Gets a range of all the vdoc documents.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	...
	public List<vdocDocument> getvdocDocuments(int start, int end)
		throws SystemException {
		return vdocDocumentPersistence.findAll(start, end);
	}

	/**
	 * Gets the number of vdoc documents.
	 *
	 * @return the number of vdoc documents
	 * @throws SystemException if a system exception occurred
	 */
	public int getvdocDocumentsCount() throws SystemException {
		return vdocDocumentPersistence.countAll();
	}

	/**
	 * Updates the vdoc document in the database. Also notifies the appropriate model listeners.
	 *
	 * @param vdocDocument the vdoc document to update
	...
	public vdocDocument updatevdocDocument(vdocDocument vdocDocument)
		...
		return vdocDocumentPersistence.update(vdocDocument, true);
	}
	 ...
	 *
	 * @param vdocDocument the vdoc document to update
	 * @param merge whether to merge the vdoc document with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the vdoc document that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public vdocDocument updatevdocDocument(vdocDocument vdocDocument,
		...
		return vdocDocumentPersistence.update(vdocDocument, merge);
	}
