...
/**
 * The base implementation of the vdoc logger local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.portlet.vdoc.service.impl.vdocLoggerLocalServiceImpl}.
 * </p>
 *
 * <p>
 * Never modify or reference this class directly. Always use {@link com.portlet.vdoc.service.vdocLoggerLocalServiceUtil} to access the vdoc logger local service.
 * </p>
 *
 * @author vinhnt
 * @see com.portlet.vdoc.service.impl.vdocLoggerLocalServiceImpl
 * @see com.portlet.vdoc.service.vdocLoggerLocalServiceUtil
 * @generated
 */
public abstract class vdocLoggerLocalServiceBaseImpl
	implements vdocLoggerLocalService {
	/**
	 * Adds the vdoc logger to the database. Also notifies the appropriate model listeners.
	 *
	 * @param vdocLogger the vdoc logger to add
	 * @return the vdoc logger that was added
	 * @throws SystemException if a system exception occurred
	 */
	public vdocLogger addvdocLogger(vdocLogger vdocLogger)
		throws SystemException {
		vdocLogger.setNew(true);

		return vdocLoggerPersistence.update(vdocLogger, false);
	}
	 ...
	 */
	public vdocLogger createvdocLogger(String loggerId) {
		return vdocLoggerPersistence.create(loggerId);
	}

	/**
	 * Deletes the vdoc logger with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param loggerId the primary key of the vdoc logger to delete
	 * @throws PortalException if a vdoc logger with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public void deletevdocLogger(String loggerId)
		throws PortalException, SystemException {
		vdocLoggerPersistence.remove(loggerId);
	}

	/**
	 * Deletes the vdoc logger from the database. Also notifies the appropriate model listeners.
	 *
	 * @param vdocLogger the vdoc logger to delete
	 * @throws SystemException if a system exception occurred
	 */
	public void deletevdocLogger(vdocLogger vdocLogger)
		throws SystemException {
		vdocLoggerPersistence.remove(vdocLogger);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return vdocLoggerPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return vdocLoggerPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return vdocLoggerPersistence.countWithDynamicQuery(dynamicQuery);
	}

	/**
	 * Gets the vdoc logger with the primary key.
	 *
	 * @param loggerId the primary key of the vdoc logger to get
	 * @return the vdoc logger
	 * @throws PortalException if a vdoc logger with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public vdocLogger getvdocLogger(String loggerId)
		throws PortalException, SystemException {
		return vdocLoggerPersistence.findByPrimaryKey(loggerId);
	}

	/**
	 * Gets a range of all the vdoc loggers.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<vdocLogger> getvdocLoggers(int start, int end)
		throws SystemException {
		return vdocLoggerPersistence.findAll(start, end);
	}

	/**
	 * Gets the number of vdoc loggers.
	 *
	 * @return the number of vdoc loggers
	 * @throws SystemException if a system exception occurred
	 */
	public int getvdocLoggersCount() throws SystemException {
		return vdocLoggerPersistence.countAll();
	}

	/**
	 * Updates the vdoc logger in the database. Also notifies the appropriate model listeners.
	 *
	 * @param vdocLogger the vdoc logger to update
	 * @return the vdoc logger that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public vdocLogger updatevdocLogger(vdocLogger vdocLogger)
		throws SystemException {
		vdocLogger.setNew(false);

		return vdocLoggerPersistence.update(vdocLogger, true);
	}
	 ...
	 *
	 * @param vdocLogger the vdoc logger to update
	 * @param merge whether to merge the vdoc logger with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the vdoc logger that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public vdocLogger updatevdocLogger(vdocLogger vdocLogger, boolean merge)
		throws SystemException {
		vdocLogger.setNew(false);

		return vdocLoggerPersistence.update(vdocLogger, merge);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = vdocLoggerPersistence.getDataSource();
