...
/**
 * The base implementation of the vdoc field local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.portlet.vdoc.service.impl.vdocFieldLocalServiceImpl}.
 * </p>
 *
 * <p>
 * Never modify or reference this class directly. Always use {@link com.portlet.vdoc.service.vdocFieldLocalServiceUtil} to access the vdoc field local service.
 * </p>
 *
 * @author vinhnt
 * @see com.portlet.vdoc.service.impl.vdocFieldLocalServiceImpl
 * @see com.portlet.vdoc.service.vdocFieldLocalServiceUtil
 * @generated
 */
public abstract class vdocFieldLocalServiceBaseImpl
	implements vdocFieldLocalService {
	/**
	 * Adds the vdoc field to the database. Also notifies the appropriate model listeners.
	 *
	 * @param vdocField the vdoc field to add
	 * @return the vdoc field that was added
	 * @throws SystemException if a system exception occurred
	 */
	public vdocField addvdocField(vdocField vdocField)
		throws SystemException {
		vdocField.setNew(true);

		return vdocFieldPersistence.update(vdocField, false);
	}
	 ...
	 */
	public vdocField createvdocField(String fieldId) {
		return vdocFieldPersistence.create(fieldId);
	}

	/**
	 * Deletes the vdoc field with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param fieldId the primary key of the vdoc field to delete
	 * @throws PortalException if a vdoc field with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public void deletevdocField(String fieldId)
		throws PortalException, SystemException {
		vdocFieldPersistence.remove(fieldId);
	}

	/**
	 * Deletes the vdoc field from the database. Also notifies the appropriate model listeners.
	 *
	 * @param vdocField the vdoc field to delete
	 * @throws SystemException if a system exception occurred
	 */
	public void deletevdocField(vdocField vdocField) throws SystemException {
		vdocFieldPersistence.remove(vdocField);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return vdocFieldPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return vdocFieldPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return vdocFieldPersistence.countWithDynamicQuery(dynamicQuery);
	}

	/**
	 * Gets the vdoc field with the primary key.
	 *
	 * @param fieldId the primary key of the vdoc field to get
	 * @return the vdoc field
	 * @throws PortalException if a vdoc field with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public vdocField getvdocField(String fieldId)
		throws PortalException, SystemException {
		return vdocFieldPersistence.findByPrimaryKey(fieldId);
	}

	/**
	 * Gets a range of all the vdoc fields.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<vdocField> getvdocFields(int start, int end)
		throws SystemException {
		return vdocFieldPersistence.findAll(start, end);
	}

	/**
	 * Gets the number of vdoc fields.
	 *
	 * @return the number of vdoc fields
	 * @throws SystemException if a system exception occurred
	 */
	public int getvdocFieldsCount() throws SystemException {
		return vdocFieldPersistence.countAll();
	}

	/**
	 * Updates the vdoc field in the database. Also notifies the appropriate model listeners.
	 *
	 * @param vdocField the vdoc field to update
	 * @return the vdoc field that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public vdocField updatevdocField(vdocField vdocField)
		throws SystemException {
		vdocField.setNew(false);

		return vdocFieldPersistence.update(vdocField, true);
	}
	 ...
	 *
	 * @param vdocField the vdoc field to update
	 * @param merge whether to merge the vdoc field with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the vdoc field that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public vdocField updatevdocField(vdocField vdocField, boolean merge)
		throws SystemException {
		vdocField.setNew(false);

		return vdocFieldPersistence.update(vdocField, merge);
	}
