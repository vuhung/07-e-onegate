...
<script language="javascript">
	...
	function <portlet:namespace />hide1(){
		var isAttach = document.getElementById('<portlet:namespace/>isAttach');r
...
<tr>
	<td width="50%" valign="top">
		...
		<tr height="30">
			<td><label for="<portlet:namespace/>isTyping">Hi&#7875;n th&#7883; b&#7897; gõ ti&#7871;ng Vi&#7879;t:</label></td>
		...
		<tr id="<portlet:namespace/>style" style="display:<%= _isTyping ? "" : "none"%>">
			<td>
				...
				<tr height="30">
					<td width="5">
					<td><label for="<portlet:namespace/>style_1">B&#7897; gõ &#273;&#7847;y &#273;&#7911;</label></td>
				...
				<tr height="30">
					<td/>
					<td><label for="<portlet:namespace/>style_2">B&#7897; gõ &#273;&#417;n gi&#7843;n</label></td>
	...
	<td valign="top">
		<table class="lfr-table">
		<tr height="30">
			<td><label for="<portlet:namespace/>isCodeActive">Hi&#7875;n th&#7883; mã xác nh&#7853;n:</label></td>
			<td><input type="checkbox" name="<portlet:namespace/>isCodeActive" id="<portlet:namespace/>isCodeActive" <%= isCodeActive.equals("true") ? "checked":""%>></td>
		</tr>
