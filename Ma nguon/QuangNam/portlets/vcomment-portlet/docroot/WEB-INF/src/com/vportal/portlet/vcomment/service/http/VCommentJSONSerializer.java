 ...
 * @generated
 */
public class VCommentJSONSerializer {
	public static JSONObject toJSONObject(VComment model) {
	...
	public static JSONArray toJSONArray(
		com.vportal.portlet.vcomment.model.VComment[] models) {
		JSONArray jsonArray = JSONFactoryUtil.createJSONArray();

		for (VComment model : models) {
	...
	public static JSONArray toJSONArray(
		List<com.vportal.portlet.vcomment.model.VComment> models) {
		JSONArray jsonArray = JSONFactoryUtil.createJSONArray();
