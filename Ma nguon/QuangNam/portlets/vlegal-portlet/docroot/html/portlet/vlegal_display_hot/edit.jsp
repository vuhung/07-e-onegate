...
<portlet:actionURL windowState="<%= WindowState.MAXIMIZED.toString() %>" name="processConfig" var="ConfigURL"></portlet:actionURL>
...
<script type="text/javascript">
	function <portlet:namespace />saveConfiguration() {
		...
		submitForm(document.<portlet:namespace />fm, '<%= ConfigURL.toString() %>');
	}
...
<table width="100%" border="0" cellpadding="4" cellspacing="1">
	...
	<tr>
    	<td width="50%">
			<img src="/html/portlet/vlegaldraftmenu/images/editcopy.png"/> L&#7921;a ch&#7885;n <b>Portlet Hi&#7875;n th&#7883; v&#259;n b&#7843;n pháp quy</b>:
    	</td>
		<td>
	...
	<tr>
		<td><img src="/html/portlet/vlegaldraftmenu/images/editcopy.png"/> V&#259;n b&#7843;n &#273;&#432;&#7907;c ban hành cách &#273;ây</td>
		<td>
			<select name="<portlet:namespace/>period">
				<option value="1" <%= period.equals("1") ? "selected":""%>>1 thang</option>
				<option value="3" <%= period.equals("3") ? "selected":""%>>3 thang</option>
				<option value="6" <%= period.equals("6") ? "selected":""%>>6 thang</option>
				<option value="12" <%= period.equals("12") ? "selected":""%>>12 thang</option>
			</select>
		</td>
	</tr>
		
	<tr>	
		<td><img src="/html/portlet/vlegaldraftmenu/images/editcopy.png"/> S&#7889; v&#259;n b&#7843;n &#273;&#432;&#7907;c hi&#7875;n th&#7883;</td>
		<td>
	...
	<tr>
		<td><img src="/html/portlet/vlegaldraftmenu/images/editcopy.png"/> Cho phép cu&#7897;n n&#7897;i dung</td>
		<td><input type="checkbox" name="<portlet:namespace/>isMarquee" <%= isMarquee ? "checked" : ""%>/>
	</tr>
</table>
...
<tr>	
	...
	<tr height="25">
		...
		<td><input type="text" name="<portlet:namespace/>titlePortlet" style="width:200px;" value="<%=title%>"></td>		
	</tr>	
	<tr height="25">
