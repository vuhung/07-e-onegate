 ...
 * @generated
 */
public class VLegalLoggerJSONSerializer {
	public static JSONObject toJSONObject(VLegalLogger model) {
	...
	public static JSONArray toJSONArray(
		com.vportal.portlet.vlegal.model.VLegalLogger[] models) {
	...
	public static JSONArray toJSONArray(
		List<com.vportal.portlet.vlegal.model.VLegalLogger> models) {
		JSONArray jsonArray = JSONFactoryUtil.createJSONArray();
