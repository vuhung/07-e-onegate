 ...
 * @generated
 */
public class VLegalTypeJSONSerializer {
	public static JSONObject toJSONObject(VLegalType model) {
		...
		jsonObj.put("statusType", model.getStatusType());
	...
	public static JSONArray toJSONArray(
		com.vportal.portlet.vlegal.model.VLegalType[] models) {
	...
	public static JSONArray toJSONArray(
		List<com.vportal.portlet.vlegal.model.VLegalType> models) {
		JSONArray jsonArray = JSONFactoryUtil.createJSONArray();
