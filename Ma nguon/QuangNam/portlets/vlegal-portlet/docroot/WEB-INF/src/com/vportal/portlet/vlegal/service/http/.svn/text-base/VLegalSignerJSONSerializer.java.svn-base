 ...
 * @generated
 */
public class VLegalSignerJSONSerializer {
	public static JSONObject toJSONObject(VLegalSigner model) {
		...
		jsonObj.put("statusSigner", model.getStatusSigner());

		return jsonObj;
	}

	public static JSONArray toJSONArray(
		com.vportal.portlet.vlegal.model.VLegalSigner[] models) {
	...
	public static JSONArray toJSONArray(
		List<com.vportal.portlet.vlegal.model.VLegalSigner> models) {
		JSONArray jsonArray = JSONFactoryUtil.createJSONArray();
