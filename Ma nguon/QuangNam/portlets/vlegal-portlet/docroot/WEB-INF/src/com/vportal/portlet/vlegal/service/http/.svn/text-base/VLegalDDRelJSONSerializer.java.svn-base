 ...
 * @generated
 */
public class VLegalDDRelJSONSerializer {
	public static JSONObject toJSONObject(VLegalDDRel model) {
	...
	public static JSONArray toJSONArray(
		com.vportal.portlet.vlegal.model.VLegalDDRel[] models) {
	...
	public static JSONArray toJSONArray(
		List<com.vportal.portlet.vlegal.model.VLegalDDRel> models) {
		JSONArray jsonArray = JSONFactoryUtil.createJSONArray();
