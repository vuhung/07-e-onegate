...
/**
 * The base implementation of the v legal t d rel remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.vportal.portlet.vlegal.service.impl.VLegalTDRelServiceImpl}.
 * </p>
 *
 * <p>
 * Never modify or reference this class directly. Always use {@link com.vportal.portlet.vlegal.service.VLegalTDRelServiceUtil} to access the v legal t d rel remote service.
 * </p>
 *
 * @author ACB
 ...
 * @generated
 */
public abstract class VLegalTDRelServiceBaseImpl extends PrincipalBean
	implements VLegalTDRelService {
	/**
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = vLegalTDRelPersistence.getDataSource();
