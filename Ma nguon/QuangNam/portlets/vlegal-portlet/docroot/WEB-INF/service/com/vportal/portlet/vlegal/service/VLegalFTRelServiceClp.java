 ...
 * @author ACB
 */
public class VLegalFTRelServiceClp implements VLegalFTRelService {
	public VLegalFTRelServiceClp(ClassLoaderProxy classLoaderProxy) {
		_classLoaderProxy = classLoaderProxy;
	}

	public com.vportal.portlet.vlegal.model.VLegalFTRel addRelation(
		...
		return (com.vportal.portlet.vlegal.model.VLegalFTRel)ClpSerializer.translateOutput(returnObj);
	}
	...
	public void deleteRelByType(java.lang.String typeId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException,
			java.rmi.RemoteException {
		MethodHandler methodHandler = new MethodHandler(_deleteRelByTypeMethodKey3,
				typeId);
	...
	public java.util.List getRelByType(java.lang.String typeId)
		...
		MethodHandler methodHandler = new MethodHandler(_getRelByTypeMethodKey4,
				typeId);
	...
	private MethodKey _deleteRelByTypeMethodKey3 = new MethodKey(_classLoaderProxy.getClassName(),
			"deleteRelByType", java.lang.String.class);
	private MethodKey _getRelByTypeMethodKey4 = new MethodKey(_classLoaderProxy.getClassName(),
			"getRelByType", java.lang.String.class);
