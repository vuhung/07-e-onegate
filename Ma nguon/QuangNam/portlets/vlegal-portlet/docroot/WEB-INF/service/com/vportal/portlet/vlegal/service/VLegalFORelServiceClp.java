 ...
 * @author ACB
 */
public class VLegalFORelServiceClp implements VLegalFORelService {
	public VLegalFORelServiceClp(ClassLoaderProxy classLoaderProxy) {
		_classLoaderProxy = classLoaderProxy;
	}

	public com.vportal.portlet.vlegal.model.VLegalFORel addRelation(
		...
		return (com.vportal.portlet.vlegal.model.VLegalFORel)ClpSerializer.translateOutput(returnObj);
	}
	...
	public void deleteRelByOrg(java.lang.String orgId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException,
			java.rmi.RemoteException {
		MethodHandler methodHandler = new MethodHandler(_deleteRelByOrgMethodKey3,
				orgId);
	...
	public java.util.List getRelByField(java.lang.String fieldId)
		...
		MethodHandler methodHandler = new MethodHandler(_getRelByFieldMethodKey4,
				fieldId);
	...
	public java.util.List getRelByOrg(java.lang.String orgId)
		...
		MethodHandler methodHandler = new MethodHandler(_getRelByOrgMethodKey5,
				orgId);
	...
	private MethodKey _deleteRelByOrgMethodKey3 = new MethodKey(_classLoaderProxy.getClassName(),
			"deleteRelByOrg", java.lang.String.class);
	private MethodKey _getRelByFieldMethodKey4 = new MethodKey(_classLoaderProxy.getClassName(),
			"getRelByField", java.lang.String.class);
	private MethodKey _getRelByOrgMethodKey5 = new MethodKey(_classLoaderProxy.getClassName(),
			"getRelByOrg", java.lang.String.class);
}