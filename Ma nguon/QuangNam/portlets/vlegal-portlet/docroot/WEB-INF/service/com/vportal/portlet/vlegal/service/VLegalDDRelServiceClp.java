 ...
 * @author ACB
 */
public class VLegalDDRelServiceClp implements VLegalDDRelService {
	public VLegalDDRelServiceClp(ClassLoaderProxy classLoaderProxy) {
	...
	public com.vportal.portlet.vlegal.model.VLegalDDRel addRelation(
		...
		return (com.vportal.portlet.vlegal.model.VLegalDDRel)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List getRelByDepartment(long departmentId)
		...
		MethodHandler methodHandler = new MethodHandler(_getRelByDepartmentMethodKey5,
				departmentId);
	...
	private MethodKey _addRelationMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
			"addRelation", long.class, java.lang.String.class);
	private MethodKey _deleteRelationMethodKey1 = new MethodKey(_classLoaderProxy.getClassName(),
			"deleteRelation", long.class, java.lang.String.class);
	...
	private MethodKey _getRelByDepartmentMethodKey5 = new MethodKey(_classLoaderProxy.getClassName(),
