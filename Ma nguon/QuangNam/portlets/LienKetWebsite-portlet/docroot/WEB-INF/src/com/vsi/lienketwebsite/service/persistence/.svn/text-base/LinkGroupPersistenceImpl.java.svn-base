...
import com.vsi.lienketwebsite.NoSuchLinkGroupException;
import com.vsi.lienketwebsite.model.LinkGroup;
import com.vsi.lienketwebsite.model.impl.LinkGroupImpl;
import com.vsi.lienketwebsite.model.impl.LinkGroupModelImpl;
...
public class LinkGroupPersistenceImpl extends BasePersistenceImpl<LinkGroup>
	 ...
	 * @return the link group that was removed
	 * @throws com.vsi.lienketwebsite.NoSuchLinkGroupException if a link group with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	...
	public LinkGroup updateImpl(
		com.vsi.lienketwebsite.model.LinkGroup linkGroup, boolean merge)
		throws SystemException {
		linkGroup = toUnwrappedModel(linkGroup);
	...
	/**
	 * Finds the link group with the primary key or throws a {@link com.vsi.lienketwebsite.NoSuchLinkGroupException} if it could not be found.
	 *
	 ...
	 * @throws com.vsi.lienketwebsite.NoSuchLinkGroupException if a matching link group could not be found
	 * @throws SystemException if a system exception occurred
	 */
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.vsi.lienketwebsite.model.LinkGroup")));
