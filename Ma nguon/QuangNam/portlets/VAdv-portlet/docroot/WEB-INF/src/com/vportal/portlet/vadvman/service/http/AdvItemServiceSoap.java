...
public class AdvItemServiceSoap {
	...
	public static com.vportal.portlet.vadvman.model.AdvItemSoap[] getAllbyType(
		long typeId) throws RemoteException {
		try {
			java.util.List returnValue = AdvItemServiceUtil.getAllbyType(typeId);

			return com.vportal.portlet.vadvman.model.AdvItemSoap.toSoapModels(returnValue);
		}
		catch (Exception e) {
			_log.error(e, e);
	...
	public static com.vportal.portlet.vadvman.model.AdvItemSoap[] getItemByG(
	...
	public static com.vportal.portlet.vadvman.model.AdvItemSoap[] getItemByG_S(
	...
	public static com.vportal.portlet.vadvman.model.AdvItemSoap[] getItemByParam(
