...
package com.vportal.portlet.vadvman.service.messaging;
...
import com.vportal.portlet.vadvman.service.ClpSerializer;
...
public class ClpMessageListener implements MessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			AdvTypeServiceUtil.clearService();

			AdvItemServiceUtil.clearService();
		}
	}
